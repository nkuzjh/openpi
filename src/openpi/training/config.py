...
import openpi.policies.csgo_policy as csgo_policy
...
@dataclasses.dataclass(frozen=True)
class LeRobotCsgoDataConfig(DataConfigFactory):
    """
    This config is used to configure transforms that are applied at various parts of the data pipeline.
    For your own dataset, you can copy this class and modify the transforms to match your dataset based on the comments below.
    """
    is_csgo: bool = True
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig, is_csgo: bool, csgo_config: dict) -> DataConfig:#, ignore_norm_stats: bool
        ...
        # replace the transforms below with your own.
        data_transforms = _transforms.Group(
            inputs=[csgo_policy.CsgoInputs(model_type=model_config.model_type)],
            outputs=[csgo_policy.CsgoOutputs()],
        )
    ...
    TrainConfig(
        ...
        data=LeRobotCsgoDataConfig(
            ...
            csgo_config = {
                "debug" : False,
                "data_dir" : "data/preprocessed_data",
                "train_maps": ['de_dust2','de_nuke', 'de_ancient'],
                "val_maps": ['de_dust2','de_nuke', 'de_ancient'],
                "test_maps": ['de_dust2','de_nuke', 'de_ancient'],
                # "debug_num_train_data": 100,
                # "debug_num_val_data": 100,
                "map_size": [224, 224],
                "fps_size": [224, 224],
